...
#    i find myself a bit disenchanted with the limitations - iirc kaggle has slightly more data?  but tbh even so, think i would have more fun with deeper/larger sets
